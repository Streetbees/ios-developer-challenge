...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Marveble/Permissionable.framework"
  install_framework "Pods-Marveble/SwiftyDropbox.framework"
  install_framework "Pods-Marveble/UILoader.framework"
fi
